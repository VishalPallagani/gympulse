...
export default function MedalsGrid({ medals }) {
  if (!medals?.length) {
    return (
      <section id="medals" className="apple-card p-6">
        <h2 className="font-display text-3xl font-semibold text-white md:text-4xl">Achievement Medals</h2>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <span className="text-4xl">{earned ? medal.medal_emoji || 'TROPHY' : 'LOCKED'}</span>
                {earned ? (
              ...
              <h3 className="mt-3 text-lg font-semibold text-white">{medal.medal_name}</h3>
